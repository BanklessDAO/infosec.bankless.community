...
description: "Managed DAO Email & Identities"
icon: "fas fa-comments"  # fontawesome icon pack : https://fontawesome.com/icons/
...
banner:
  ...
  content : "The InfoSec team securely manages all DAO community email address to provide streamlined access to DAO resources"
  button:
    enable : false
    label : "Try for Free"
    link : "get-demo/"
